...
Hera, MTRouter and CEB all need an estimate of the acting model's state \emph{at each
step} in order to route or intervene, and all three reconstruct it from outside the
